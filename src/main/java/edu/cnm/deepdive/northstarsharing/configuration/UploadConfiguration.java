 ...
 * edu.cnm.deepdive.northstarsharing.service.LocalFilesystemStorageService}.
 */
@Component
...
public class UploadConfiguration {
  ...
  /**
   * Return the whitelist of acceptable image file formats for upload.
   */
  ...
  /**
   * Set the whitelist of acceptable image file formats for upload.
   */
  ...
  /**
   * Utility class to hold state, and mirror the application.yml "upload" properties.
   */
