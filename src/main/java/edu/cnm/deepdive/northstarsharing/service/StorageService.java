...
public interface StorageService {
   ...
   * @throws HttpMediaTypeException If the content-type of {@code file} is not allowed.
   */
   ...
   * as well.
   *
   * @param key Opaque reference to the file, as returned by {@link #store(MultipartFile)}.
   ...
   *
   * @param key Opaque reference {@link String} returned from {@link #store(MultipartFile)}.
